...
SRCS = gen-cpp/MasterService.cpp gen-cpp/WorkerService.cpp gen-cpp/MasterService_types.cpp gen-cpp/WorkerService_types.cpp gen-cpp/SharedService.cpp gen-cpp/SharedService_types.cpp gen-cpp/SharedService_constants.cpp
